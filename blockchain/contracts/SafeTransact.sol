...
// For this project the msg.sender i.e the SafeTransact platform is assumed to be the fair and impartial 3rd party mediator.

contract SafeTransact is Ownable, ReentrancyGuard {
